...
");
            ...
            migrationBuilder.Sql(@"
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'AllowedWebsites')
BEGIN
    CREATE TABLE [AllowedWebsites] (
        ...
        CONSTRAINT [PK_AllowedWebsites] PRIMARY KEY ([Id])
    );
...
");
            ...
            migrationBuilder.Sql(@"
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'DocumentPublications')
BEGIN
    CREATE TABLE [DocumentPublications] (
        ...
        [CreatedAt] DATETIME2 NOT NULL,
        [UpdatedAt] DATETIME2 NOT NULL,
        CONSTRAINT [PK_DocumentPublications] PRIMARY KEY ([Id]),
        CONSTRAINT [FK_DocumentPublications_AspNetUsers_PublishedByUserId]
            FOREIGN KEY ([PublishedByUserId]) REFERENCES [AspNetUsers] ([Id]),
        CONSTRAINT [FK_DocumentPublications_Documents_DocumentId]
            FOREIGN KEY ([DocumentId]) REFERENCES [Documents] ([Id]) ON DELETE CASCADE
    );
    CREATE UNIQUE INDEX [IX_DocumentPublications_DocumentId] ON [DocumentPublications] ([DocumentId]);
    CREATE INDEX [IX_DocumentPublications_PublishedByUserId] ON [DocumentPublications] ([PublishedByUserId]);
END
");
        }
